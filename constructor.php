<?php
    class user{
        ...
        public function_construct($username, $email,$password)
        {
    ...
    class Admin extends user
    {
        ...
        public function_construct($username,$email,$password,$role)
        {
            parent::_construct($username)
        ...
        $user =new user('kusal@gmail.com','kusal@gmail.com','rrr');
        $user = new user();
       // $user->username = 'hd';
        $user->login();
        echo "<br>";
